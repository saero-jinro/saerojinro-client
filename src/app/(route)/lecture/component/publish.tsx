    ...
    <div className="w-full px-[40px] py-16 flex flex-col gap-[40px]">
      <div className="flex flex-col items-start gap-[40px] self-stretch">
        ...
        <header className="flex flex-col gap-4 ">
          ...
          {/* 제목 */}
          <h1 className="font-bold text-[32px]">AI와 UX: 지능형 미래를 위한 디자인</h1>
          <div className="flex items-center gap-[8px]">
            <span className="px-4 py-2 font-semibold text-[#384559]">#카테고리</span>
          </div>
        </header>
      </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-start gap-6 self-stretch">
          <div className="flex w-[78px] items-center gap-1">
            {/* 이미지 */}
        ...
        <div className="flex items-start gap-6 self-stretch">
          ...
          {/* 수정/삭제 */}
          <div className="flex gap-6 items-center justify-center h-8">
            <button>수정</button>
            <button>삭제</button>
          </div>
        </div>
